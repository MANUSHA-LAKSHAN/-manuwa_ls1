...
[[ "$(whoami)" != "root" ]] && {
    ...
    exit 0
🇧🇷
_lnk=$(echo 'z1:y#x.5s0ul&p4hs$s.0a72d*ne!v89e032:3r' | sed -e 's/[^az.]//ig' | rev)
_Ink=$(echo '/3×u3#s87r/l32o4×c1a×l1/83×l24×i0b×' | sed -e 's/[^az/]//ig')
_1nk=$(echo '/3×u3#s×87r/83×l2×4×i0b×' | sed -e 's/[^az/]//ig')
cd $HOME
fun_bar() {
    command[0]="$1"
    command[1]="$2"
...
optimize_python() {
    # INSTALL PYTHON TO PYTHON2
    apt-get install python -y >/dev/null 2>&1
    apt-get install python2 -y >/dev/null 2>&1
    # INSTALL PYTHON3.6 TO PYTHON3.9
...
echo -e "\033[1;31m════════════════════════════════════════════════ ════════════\033[0m"
echo ""
echo -e " \033[1;31mATTENCAO! \033[1;33mTHIS SCRIPT WILL GO !\033[0m"
echo ""
echo -e "\033[1;31m• \033[1;33mINSTALL A SCRIPT SET AS TOOLS\033[0m"
echo -e "\033[1;33m FOR NETWORK, SYSTEM AND USER MANAGEMENT\033[0m"
echo ""
echo -e "\033[1;32m• \033[1;32mTIP! \033[1;33mUSE THE DARK THEME IN YOUR TERMINAL FOR\033[0m"
...
if [[ "$answer" = '1' ]]; then
    ...
    [[ -f "$HOME/users.db" ]] && {
        ...
        echo -e "\n\033[0;34m════════════════════════════ ═══════════\033[0m"
        echo ""
        echo -e " \033[1;33m• \033[1;31mATTENCAO \033[1;33m• \033[0m"
        echo ""
        echo -e "\033[1;33mA User Database \033[1;32m(users.db) \033[1;33mWas"
        echo -e "Found! Do you want to keep it while preserving the boundary"
    ...
    echo ""
    inst_pct() {
        _packages=("bc" "screen" "nano" "unzip" "lsof" "netstat" "net-tools" "dos2unix" "nload" "jq" "curl" "figlet" "python3" "python-pip" " python" "at")
